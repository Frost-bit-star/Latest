...
db.serialize(() => {
  ...
  db.get(`SELECT * FROM pairing_codes WHERE verified = 1 ORDER BY created_at DESC LIMIT 1`, (err, row) => {
...
• ${notifyCodes}`);
        ...
        console.log("🆕 No WhatsApp session found. Waiting for manual pairing...");
      });
      return;
    }
